...
public class QuakeEntry implements Comparable<QuakeEntry>{
	...
	public int compareTo(QuakeEntry loc) {
		double currentMagnitude = loc.getMagnitude();
		if (magnitude == currentMagnitude) {
		    double currentDepth = loc.getDepth();
		    return Double.compare(depth, currentDepth);
        }
        return Double.compare(magnitude, currentMagnitude);
